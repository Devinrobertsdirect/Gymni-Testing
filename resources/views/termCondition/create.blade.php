...
<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>Add Terms & Policies</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{ route('dashboard')}}">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="{{ route('termCondition.index')}}">Terms & Policy</a></li>
                  <li class="breadcrumb-item active">Add Terms & Policies</li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8">
               <div class="card card-primary">
                  ...
                  <div class="card-header color-me">
                     <h3 class="card-title">Add Terms & Policies</h3>
                  </div>
                  <div class="card-body">
                     <form action="{{ route('termCondition.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                              ...
                              <!--<textarea onkeypress="onTestChange();" class="form-control" id="content" name="content" rows="4" cols="50" required>{{old('content')}}</textarea>-->
                               <input type="text" class="form-control" id="content" name="content" value="{{old('content')}}" placeholder="Enter Url" required>
                        </div>
