                ...
                <div class="col-md-10">
                    <div class="card card-primary my-select">
                        ...
                        <div class="card-header color-me">
                            <h3 class="card-title">Edit  Demo Video</h3>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('demovideo.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                            <div class="form-group">
                                    <input type="hidden" class="form-control" id="id" name="id" placeholder="Enter Title" required value='<?php echo $data[0]->id; ?>'>
                                </div>
                                <div class="form-group">
                                    <label for="group_name">Title</label>
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" required value='<?php echo $data[0]->title; ?>'>
                                </div>

                                <div class="form-group">
                                    <label for="group_name">Demo Video Code (.MP4)</label>
                                    <textarea placeholder="Enter Embed Code" name="url" rows="8" cols="50" class="form-control"><?php echo $data[0]->url; ?></textarea>
                                    <!-- <input type="text" class="form-control" id="url" name="url" placeholder="Enter URL" required value='<?php //echo $data[0]->url; ?>'> -->
                                </div>

                                <div class="form-group">
                                    <label for="group_name">Tutorial Video Code (.MP4)</label>
                                    <textarea placeholder="Enter Embed Code" name="url2"  rows="8" cols="50"
                                        class="form-control"><?php echo $data[0]->url2; ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="thumbnail" accept=".png, .jpg, .jpeg">
                                    <img src="{{url('/costumThumbimg/'.$data[0]->costum_thumImg)}}" alt="{{$data[0]->title}}" width="171px">
                                </div>

                                <div class="form-group">
                                  
                                    <label for="content">Video Description</label>
                                    <textarea onkeypress="onTestChange();" class="form-control" id="group_description" name="group_description" rows="8" cols="50" required><?php echo $data[0]->description; ?></textarea>
                                </div>
                                <div class="form-group" style="display:none">
                        <label>Select Category</label>
                           <select class="form-control" name="categorty" id="ssss">
                                  <option value="Video" <?php if($data[0]->category== 'Demo Video'){ echo "selected";} ?>>Demo Video</option>
                                  <option  value="Workout Video" <?php if($data[0]->category== 'Workout Video'){ echo "selected";} ?>>Workout Video</option>
                           </select>
                      </div>
                                ...
                                <div class="form-group">
                                    <label>Add Demo Tag</label>
                                      <input type="text" data-role="tagsinput" name="tag[]" value="<?php echo $data[0]->tag ?>">
                                </div>
                        </div>  
