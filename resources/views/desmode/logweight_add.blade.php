                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="title">Title Of the Workout {{$id}}</label>
                                        <select class="form-control comman" id="title" name="workout_title" value="" placeholder="Title Of The Workout" required="">
                                            ...
                                            <option value="{{$row->id}}" @if($row->id==$id)
                                                {{'selected'}}
                                                @endif
                                                >{{ $row->video_title }}
                                            </option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="add-inline-exercise">
                                            <input type="text" class="form-control" id="title" maxlength="25" name="exercise[]" value="" placeholder="Exercise Name" required="">
                                            <input type="number" class="form-control" id="title" maxlength="25" name="count[]" value="" placeholder="Count" required="">
                                            <input type="number" class="form-control" id="title" maxlength="25" name="reps[]" value="" placeholder="Reps" required="">
                                ...
                                <div class="text-center w-100 border-0">
                                    ...
                                    <a href="{{url('logweight-List')}}" class="cancel-btn">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
