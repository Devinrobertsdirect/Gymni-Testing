            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-primary my-select">
                        ...
                        <div class="card-body">
                            <form action="{{ route('videomode.store') }}" method="POST"  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <?php
                                ...
                                //         //print_r($result_countries);

                                //         $newarr = array_diff($result_countries, array(" "));
                                //        // print_r($newarr);

                                //         foreach ($newarr as $country) {
                               ...
                               // print_r($get_workout_tags);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control get_workout" id="selectVideo" required>
                                            <option value="">Select Video</option>
                                           
                                          @foreach($get_workout_tag as $get_workout_tagss)
                                             @if(!empty(($get_workout_tagss)))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="video_title" required class="form-control" id="video_title" name="video_title" value="{{old('video_title')}}" placeholder="Enter Name">
                                        <span class="video_title_error text-danger"></span>
                                    </div>

                                    <div class="form-group">
                                        <label for="text">Description</label>
                                        <textarea  id="summernote" rows="4" cols="50" name="description">{{old('description')}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="equipment" value="{{old('equipment')}}" placeholder="Enter Equipment" maxlength="25" name="equipment">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="intensity_rating" class="custom-select rounded-0" id="intensity_rating">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="workout_time">
                                    ...
                                    <div class="form-group">
                                        <label>Select Demo Video Tag</label>
...
//     $("#selectVideo").chosen().change(function(){
//         var id = $(this).val();
//         alert(id);
//     });
// })
